# -*- coding: utf-8 -*-
"""
Created on Fri Feb  5 09:58:12 2021
...
def game(): 
    ...
    from mypackage.linear_congruence import linear_congruence
    ...
    for turn in range (moves): 
        while True: 
            try: 
                player_move = int(input("Choose your move for round: %s (0 or 1): " % (turn+1)))
        ...
        if select_difficulty == 1: #if game ais easy
            computer_move, xi = linear_congruence(xi)
    ...
    restart = input("Do you want to start a new game? Yes (Y) or No (N):")
